...
object AtlasUpgradeObjects {
    ...
    val all: List<AtlasEntry> = listOf(
        ...
        entry(12, "Smart Casts", "Your missiles home in on the nearest enemy. Triggered automatically while firing missiles in attack mode."),
        ...
        entry(0, "Coroutines", "Your weapon turns into a continuous laser beam. Switch to attack mode and hold fire to keep the beam going."),
        ...
        entry(6, "Immutability", "Press S or push down on the left thumbstick on the ground to become immovable and invulnerable."),
        entry(10, "Scope Functions", "Hold to aim and release to fire a piercing shot. Switch to attack mode, hold fire to charge, release to shoot."),
